...
print(f"rank: {rank}, mat_A = np.loadtxt('mat_A.txt',skiprows={info[0]},max_rows={i_size})")
mat_B = np.loadtxt("mat_B.txt",skiprows=info[1],max_rows=j_size)
print(f"rank: {rank}, mat_B = np.loadtxt('mat_B.txt',skiprows={info[1]},max_rows={j_size})")
